...
public class ModelMimicOctopus extends AdvancedEntityModel<EntityMimicOctopus> {
    private final AdvancedModelBox root,body,leftEye,leftEyeSpike,rightEye,rightEyeSpike;
    private final AdvancedModelBox leftFrontArm1,rightFrontArm1,leftFrontArm2,rightFrontArm2;
    private final AdvancedModelBox leftBackArm1,rightBackArm1,leftBackArm2,rightBackArm2;
    private final AdvancedModelBox mantle,creeperPivots1,creeperPivots2,creeperPivots3,creeperPivots4;

    public ModelMimicOctopus(){texWidth=64;texHeight=64;
        root=new AdvancedModelBox(this,"root");root.setRotationPoint(0.0F,24.0F,0.0F);
        body=new AdvancedModelBox(this,"body");body.setRotationPoint(0.0F,-3.0F,0.0F);root.addChild(body);body.setTextureOffset(30,24).addBox(-3.0F,-2.0F,-4.0F,6.0F,4.0F,7.0F,0.0F,false);
        leftEye=new AdvancedModelBox(this,"leftEye");leftEye.setRotationPoint(2.0F,-2.0F,-2.5F);body.addChild(leftEye);leftEye.setTextureOffset(35,18).addBox(-1.0F,-1.0F,-1.5F,2.0F,1.0F,3.0F,0.0F,false);
        leftEyeSpike=new AdvancedModelBox(this,"leftEyeSpike");leftEyeSpike.setRotationPoint(-1.0F,-1.0F,-1.5F);leftEye.addChild(leftEyeSpike);leftEyeSpike.setTextureOffset(0,0).addBox(0.0F,-4.0F,0.0F,0.0F,4.0F,2.0F,0.0F,false);
        rightEye=new AdvancedModelBox(this,"rightEye");rightEye.setRotationPoint(-2.0F,-2.0F,-2.5F);body.addChild(rightEye);rightEye.setTextureOffset(35,18).addBox(-1.0F,-1.0F,-1.5F,2.0F,1.0F,3.0F,0.0F,true);
        rightEyeSpike=new AdvancedModelBox(this,"rightEyeSpike");rightEyeSpike.setRotationPoint(1.0F,-1.0F,-1.5F);rightEye.addChild(rightEyeSpike);rightEyeSpike.setTextureOffset(0,0).addBox(0.0F,-4.0F,0.0F,0.0F,4.0F,2.0F,0.0F,true);
        leftFrontArm1=new AdvancedModelBox(this,"leftFrontArm1");leftFrontArm1.setRotationPoint(2.0F,2.0F,-4.0F);setRotationAngle(leftFrontArm1,0.0F,0.6109F,0.0F);leftFrontArm1.setTextureOffset(26,0).addBox(-1.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,false);leftFrontArm1.setTextureOffset(35,11).addBox(11.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,false);
        rightFrontArm1=new AdvancedModelBox(this,"rightFrontArm1");rightFrontArm1.setRotationPoint(-2.0F,2.0F,-4.0F);setRotationAngle(rightFrontArm1,0.0F,-0.6109F,0.0F);rightFrontArm1.setTextureOffset(26,0).addBox(-15.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,true);rightFrontArm1.setTextureOffset(35,11).addBox(-15.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,true);
        leftFrontArm2=new AdvancedModelBox(this,"leftFrontArm2");leftFrontArm2.setRotationPoint(2.0F,2.0F,-2.3F);setRotationAngle(leftFrontArm2,0.0F,0.3054F,0.0F);leftFrontArm2.setTextureOffset(0,26).addBox(-1.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,false);leftFrontArm2.setTextureOffset(35,5).addBox(11.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,false);
        rightFrontArm2=new AdvancedModelBox(this,"rightFrontArm2");rightFrontArm2.setRotationPoint(-2.0F,2.0F,-2.3F);setRotationAngle(rightFrontArm2,0.0F,-0.3054F,0.0F);rightFrontArm2.setTextureOffset(0,26).addBox(-15.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,true);rightFrontArm2.setTextureOffset(35,5).addBox(-15.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,true);
        creeperPivots1=new AdvancedModelBox(this,"creeperPivots1");creeperPivots1.setRotationPoint(0,0,0);
        creeperPivots2=new AdvancedModelBox(this,"creeperPivots2");creeperPivots2.setRotationPoint(0,0,0);
        creeperPivots3=new AdvancedModelBox(this,"creeperPivots3");creeperPivots3.setRotationPoint(0,0,0);
        creeperPivots4=new AdvancedModelBox(this,"creeperPivots4");creeperPivots4.setRotationPoint(0,0,0);
        body.addChild(creeperPivots1);body.addChild(creeperPivots2);body.addChild(creeperPivots3);body.addChild(creeperPivots4);
        leftBackArm1=new AdvancedModelBox(this,"leftBackArm1");leftBackArm1.setRotationPoint(2.0F,2.0F,-1.0F);setRotationAngle(leftBackArm1,0.0F,-0.2182F,0.0F);leftBackArm1.setTextureOffset(0,21).addBox(-1.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,false);leftBackArm1.setTextureOffset(13,31).addBox(11.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,false);
        rightBackArm1=new AdvancedModelBox(this,"rightBackArm1");rightBackArm1.setRotationPoint(-2.0F,2.0F,-1.0F);setRotationAngle(rightBackArm1,0.0F,0.2182F,0.0F);rightBackArm1.setTextureOffset(0,21).addBox(-15.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,true);rightBackArm1.setTextureOffset(13,31).addBox(-15.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,true);
        leftBackArm2=new AdvancedModelBox(this,"leftBackArm2");leftBackArm2.setRotationPoint(2.0F,2.0F,1.0F);setRotationAngle(leftBackArm2,0.0F,-0.6981F,0.0F);leftBackArm2.setTextureOffset(0,16).addBox(-1.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,false);leftBackArm2.setTextureOffset(0,31).addBox(11.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,false);
        rightBackArm2=new AdvancedModelBox(this,"rightBackArm2");rightBackArm2.setRotationPoint(-2.0F,2.0F,1.0F);setRotationAngle(rightBackArm2,0.0F,0.6981F,0.0F);rightBackArm2.setTextureOffset(0,16).addBox(-15.0F,-1.0F,-1.0F,16.0F,2.0F,2.0F,0.0F,true);rightBackArm2.setTextureOffset(0,31).addBox(-15.0F,-4.0F,-1.0F,4.0F,3.0F,2.0F,0.0F,true);
        mantle=new AdvancedModelBox(this,"mantle");mantle.setRotationPoint(0.0F,-1.0F,2.0F);body.addChild(mantle);mantle.setTextureOffset(0,0).addBox(-4.0F,-4.0F,-2.0F,8.0F,6.0F,9.0F,0.0F,false);
        creeperPivots1.addChild(leftFrontArm1);creeperPivots1.addChild(leftFrontArm2);
        creeperPivots2.addChild(leftBackArm1);creeperPivots2.addChild(leftBackArm2);
        creeperPivots3.addChild(rightFrontArm1);creeperPivots3.addChild(rightFrontArm2);
        creeperPivots4.addChild(rightBackArm1);creeperPivots4.addChild(rightBackArm2);
        this.updateDefaultPose();}

    @Override public Iterable<BasicModelPart> parts(){return ImmutableList.of(root);}
    @Override public Iterable<AdvancedModelBox> getAllParts(){return ImmutableList.of(root,mantle,rightEye,rightEyeSpike,leftEye,leftEyeSpike,body,leftFrontArm1,leftFrontArm2,rightFrontArm1,rightFrontArm2,leftBackArm1,leftBackArm2,rightBackArm1,rightBackArm2,creeperPivots1,creeperPivots2,creeperPivots3,creeperPivots4);}
    ...
    public void setupAnim(EntityMimicOctopus entity,float limbSwing,float limbSwingAmount,float ageInTicks,float netHeadYaw,float headPitch){
        ...
        //══════ 🐙 MIMIC OCTOPUS — SEMI-AUTONOMOUS ARM EXPLORER ══════
        // IDENTITY: Each of 8 arms moves INDEPENDENTLY — different rhythms,
        // speeds, and directions — like 8 separate curious creatures.
        // Mantle pulses for jet escape. Eye spikes raise with alertness.
        // Can instant-transform into mimic shapes (Guardian/Creeper/Pufferfish).
        // UNIQUE vs GiantSquid: octopus crawls on seafloor, arms probe substrate.
        // GiantSquid jets through open water.
        ...
        //══════ INDEPENDENT ARM EXPLORATION (Default State) ══════
        // Real octopus: each arm has its own neural cluster. Arms move
        // autonomously with different rhythms. This is THE octopus signature.
        // We give each arm a UNIQUE frequency, axis, and amplitude.
        float idleCurl=1.0F-limbSwingAmount*0.6F;
        float defAmp=0.08F;

        // Arm 1 — slow wide sweep (exploring ahead)
        this.swing(leftFrontArm1,0.07F,defAmp*1.4F,true,0F,0F,ageInTicks,idleCurl);
        this.flap(leftFrontArm1,0.05F,defAmp*0.6F,false,1F,0,ageInTicks,idleCurl);
        // Arm 2 — medium curl, different phase (feeling left)
        this.swing(rightFrontArm1,0.09F,defAmp*1.1F,false,1.5F,0F,ageInTicks,idleCurl);
        this.flap(rightFrontArm1,0.06F,defAmp*0.7F,true,0.5F,0,ageInTicks,idleCurl);
        // Arm 3 — quick probing (checking crevice)
        this.swing(leftFrontArm2,0.11F,defAmp*0.9F,true,3F,0F,ageInTicks,idleCurl);
        this.flap(leftFrontArm2,0.08F,defAmp*0.5F,false,2F,0,ageInTicks,idleCurl);
        // Arm 4 — slow curl, different axis
        this.swing(rightFrontArm2,0.06F,defAmp*1.2F,false,2.5F,0F,ageInTicks,idleCurl);
        this.flap(rightFrontArm2,0.07F,defAmp*0.4F,true,3.5F,0,ageInTicks,idleCurl);
        // Arm 5 — dragging behind
        this.swing(leftBackArm1,0.08F,defAmp*0.7F,true,4F,0F,ageInTicks,idleCurl);
        // Arm 6 — trailing, gentle
        this.swing(rightBackArm1,0.07F,defAmp*0.8F,false,3F,0F,ageInTicks,idleCurl);
        // Arm 7 — probing substrate
        this.swing(leftBackArm2,0.10F,defAmp*1.0F,true,5F,0F,ageInTicks,idleCurl);
        this.flap(leftBackArm2,0.09F,defAmp*0.3F,false,1.5F,0,ageInTicks,idleCurl);
        // Arm 8 — rear guard
        this.swing(rightBackArm2,0.08F,defAmp*0.6F,false,4.5F,0F,ageInTicks,idleCurl);

        //══════ EYE SPIKES: alertness indicator ══════
        // Raised when alert, lowered when calm
        this.flap(leftEyeSpike,0.12F,0.05F,false,0F,0,ageInTicks,1);
        this.flap(rightEyeSpike,0.12F,0.05F,true,1.5F,0,ageInTicks,1);

        //══════ MANTLE SIPHON BREATHING ══════
        float breath=Mth.cos(ageInTicks*0.07F);
        mantle.setScale(1.0F+breath*0.02F,1.0F+breath*0.04F,1.0F+breath*0.02F);
        body.rotationPointY+=breath*0.05F;

        //══════ MIMIC STATE SYSTEM (preserved & enhanced) ══════
        if(entity.getPrevMimicState()!=null){
            ...
            if(sitProgress==0){animateForMimicWater(entity.getPrevMimicState(),entity,limbSwing,limbSwingAmount,ageInTicks,progress*(1-groundProgressNorm));}
        }
    ...
    public void animateForMimicWater(EntityMimicOctopus.MimicState state,EntityMimicOctopus entity,float limbSwing,float limbSwingAmount,float ageInTicks,float swimProgress){
        ...
        if(state==EntityMimicOctopus.MimicState.GUARDIAN){
            float degree=1.6F;float speed=0.5F;
            progressPositionPrev(body,swimProgress,0,-4,5,5F);
            progressPositionPrev(mantle,swimProgress,0,2,0,5F);
            if(swimProgress>0){mantle.setScale(1F+swimProgress*0.1F,1F+swimProgress*0.1F,1F+swimProgress*0.1F);}
            ...
            if(state==EntityMimicOctopus.MimicState.CREEPER){
                ...
                progressRotationPrev(mantle,swimProgress,Maths.rad(-60),0,0,5F);f=0.5F;
            }
            float degree=1.6F;float speed=0.5F;
            ...
            if(swimProgress>0){
                if(state==EntityMimicOctopus.MimicState.PUFFERFISH){
                    ...
                    mantle.setScale(f2,f2,f2);
                }else{
                    float scale=1.1F+0.3F*f*Mth.sin(speed*limbSwing-2);
                    mantle.setScale((scale-1F)*swimProgress*0.05F+1F,(scale-1F)*swimProgress*0.05F+1F,(scale-1F)*swimProgress*0.2F+1F);
                }
            }
            ...
            this.swing(leftFrontArm1,speed*0.9F,degree*0.38F,true,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(leftFrontArm2,speed*1.1F,degree*0.32F,true,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(leftBackArm1,speed*0.8F,degree*0.28F,true,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(leftBackArm2,speed*1.2F,degree*0.4F,true,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(rightFrontArm1,speed*1.0F,degree*0.35F,false,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(rightFrontArm2,speed*0.85F,degree*0.26F,false,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(rightBackArm1,speed*1.15F,degree*0.33F,false,0,-0.1F,limbSwing,limbSwingAmount);
            this.swing(rightBackArm2,speed*0.95F,degree*0.37F,false,0,-0.1F,limbSwing,limbSwingAmount);
        }
    }
    ...
    public void animateForMimicGround(EntityMimicOctopus.MimicState state,EntityMimicOctopus entity,float limbSwing,float limbSwingAmount,float ageInTicks,float groundProgress){
        mantle.setScale(1,1,1);
        limbSwingAmount=limbSwingAmount*groundProgress*0.2F;
        float degree=0.8F;float speed=0.8F;
        if(state==EntityMimicOctopus.MimicState.CREEPER){
            ...
            float idleDegree=0.02F;float idleSpeed=0.05F;
            ...
            this.swing(leftFrontArm1,speed*0.9F,degree*0.34F,true,-1,-0.3F,limbSwing,limbSwingAmount);
            this.swing(leftFrontArm2,speed*1.1F,degree*0.26F,true,-2,-0.1F,limbSwing,limbSwingAmount);
            this.swing(leftBackArm1,speed*0.8F,degree*0.22F,true,-3,-0.1F,limbSwing,limbSwingAmount);
            this.swing(leftBackArm2,speed*1.2F,degree*0.36F,true,-4,-0.2F,limbSwing,limbSwingAmount);
            this.swing(rightFrontArm1,speed*1.0F,degree*0.3F,false,-1,-0.3F,limbSwing,limbSwingAmount);
            this.swing(rightFrontArm2,speed*0.85F,degree*0.28F,false,-2,-0.1F,limbSwing,limbSwingAmount);
            this.swing(rightBackArm1,speed*1.15F,degree*0.24F,false,-3,-0.1F,limbSwing,limbSwingAmount);
            this.swing(rightBackArm2,speed*0.95F,degree*0.32F,false,-4,0.2F,limbSwing,limbSwingAmount);
            if(entity.hasGuardianLaser()){progressRotationPrev(body,groundProgress,0,Maths.rad(180),0,5F);}
        }
    }
